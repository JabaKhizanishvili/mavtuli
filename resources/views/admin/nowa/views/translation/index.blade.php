                                    ...
                                    <form class="mr-0 p-0">
                                        <th>
                                            <input class="form-control" type="number" name="id"
                                                onchange="this.form.submit()" value="{{ Request::get('id') }}"
                                                class="validate {{ $errors->has('id') ? '' : 'valid' }}">
                                        </th>
                                        <th>
                                            <input class="form-control" type="text" name="group"
                                                onchange="this.form.submit()" value="{{ Request::get('group') }}"
                                                class="validate {{ $errors->has('group') ? '' : 'valid' }}">
                                        </th>
                                        <th>
                                            <input class="form-control" type="text" name="key"
                                                onchange="this.form.submit()" value="{{ Request::get('key') }}"
                                                class="validate {{ $errors->has('key') ? '' : 'valid' }}">
                                        </th>
                                        <th>
                                            <input class="form-control" type="text" name="text"
                                                onchange="this.form.submit()" value="{{ Request::get('text') }}"
                                    ...
                                    @foreach ($translations as $key_p => $translation)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{ $url }}" class="edit-form-index"
                                                    id="edit_index_{{ $translation->id }}">
                                                            ...
                                                            <div class="tabs-menu1">
                                                                ...
                                                                <ul class="nav panel-tabs main-nav-line">
                                                                    @foreach ($languages as $key => $language)
                                                                        ...
                                                                        ?>
                                                                        <li><a href="#cat-{{ $key_p . '-' . $key }}"
                                                                                class="nav-link {{ $active }}"
                                                                                data-bs-toggle="tab">{{ $language->locale }}</a>
                                                                        </li>
                                                                    @endforeach
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                @foreach ($languages as $key => $language)
                                                                    ...
                                                                    <div class="tab-pane {{ $active }}"
                                                                        ...
                                                                        {!! Form::textarea('text[' . $key . ']', isset($translation->text[$key]) ? $translation->text[$key] : '', [
                                                                            'class' => 'form-control',
                                                                            'rows' => '1',
                                                                        ]) !!}
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary"
                                                    data-save_translation="{{ $translation->id }}">@lang('admin.save')</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
